...
5. **MAYA is required to animate the process.** A short gif of the glass fracture example can be viewed below, from which you can observe the realistic fracture effect. If the gif failed to render, please check out [`images/scene.gif`](images/scene.gif). 
